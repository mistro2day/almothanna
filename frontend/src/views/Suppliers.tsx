...
export default function Suppliers() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-slide">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold font-display tracking-tight text-[var(--text-primary)]">إدارة الموردين</h1>
          <p className="text-[var(--text-secondary)] mt-1 text-sm md:text-base">تتبع شركات الأدوية والموزعين والمصانع مع البيانات المالية</p>
        </div>
